...
class LoggingConfig:
    ...
    checkpoint_dir: str = "data_dino_v4/checkpoints"
    log_dir: str = "data_dino_v4/logs"
...
class DataConfig:
    ...
    goal_cache_dir: str = "data_dino_v4/goal_datasets"
    # Pre-cached CLIP embeddings for ImageNav goal images
    # generated by tools/cache_goal_embeddings.py
    goal_cache_file: str = "data_dino_v4/goal_datasets/imagenav_robothor_clip_vitb32.pkl"
